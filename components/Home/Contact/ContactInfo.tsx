    ...
    <div>
      <div className='flex items-center space-x-8'>
        ...
        <div>
          ...
          <h1 className='text-base sm:text-lg text-white text-opacity710'>{contactData.phone}</h1>
        </div>
      </div>
      <div className='flex items-center space-x-8 mt-8 mb-8'>
        ...
        <div>
          ...
          <h1 className='text-base sm:text-lg text-white text-opacity710'>{contactData.email}</h1>
        </div>
      </div>
      <div className='flex items-center space-x-8'>
        <div className='w-10 h-10 md:w-16 md:h-16 rounded-full bg-gradient-to-r from-emerald-500 to bg-emerald-900 flex items-center justify-center flex-col'>
        ...
        <div>
          ...
          <h1 className='text-base sm:text-lg text-white text-opacity710'>{contactData.address}</h1>
        </div>
      </div>
    </div>
  )
