    ...
    <div className='pt-16 pb-16 bg-[#050709]' id="about">
        ...
        <div className='w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap 8 items-center mt-20'>
            ...
            <div data-aos="fade-left" data-aos-achor-placement="top-center">
                ...
                <div className='mt-8'>
                    <div className='flex item-center space-x-2 mb-6'>
            ...
            {/* stats content */}
            <div data-aos="zoom-in" data-aos-delay="150" data-aos-achor-placement="top-center" className='grid grid-cols-2 gap-16 item-center lg:mx-auto'>
                <div>
